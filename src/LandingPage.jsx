  ...
  return (
    <div className="app">
      ...
      <section id="body-content" className="body-content">
        ...
        <p>
          At Coffee Shop, we take pride in sourcing the best coffee beans and
          brewing them to perfection. Whether you are a fan of espresso, lattes,
          or cappuccinos, we are got something for every coffee lover!
        </p>
      </section>
